...
/* Y positions bien séparées : Haut y:33 · Bas y:62 · Chaussures y:88        */
/* Cravate/NP y:40 uniquement si portés · Chapeau y:12 uniquement si porté   */
const _WA_STL = "33664826920";
const _STL_SPOTS = [
  [ // 0 — Costume Crème
    { x:36, y:33, label:"Haut — Costume 3 pièces crème", detail:"Lin crème sur-mesure, revers en pointe, coupe ajustée — veste + gilet + pantalon assortis, doublure soie ivoire" },
    { x:50, y:62, label:"Bas — Pantalon crème assorti", detail:"Lin crème sur-mesure, coupe droite, revers 2 cm, pli marqué — fait main, assorti au gilet" },
    { x:44, y:88, label:"Chaussures — Derby bicolores", detail:"Cuir caramel & crème, semelle Goodyear, chaussettes fil d'Écosse crème — fabrication artisanale" },
  ],
  [ // 1 — Élégance Blanche
    ...
    { x:50, y:62, label:"Bas — Pantalon blanc à revers", detail:"Blanc cassé, coupe droite, revers 2 cm, pli creux — laine légère sur-mesure, fait main" },
    { x:44, y:88, label:"Chaussures — Derby blancs cuir", detail:"Cuir blanc patiné, bout captoe, semelle cuir naturel, chaussettes soie blanche ultra-fine" },
  ],
  [ // 2 — Veste Rayée
    ...
    { x:51, y:41, label:"Cravate — Soie navy slim", detail:"Soie navy 6 cm, motifs discrets tissés, nœud four-in-hand — longueur ajustée sur-mesure" },
    { x:50, y:62, label:"Bas — Pantalon navy uni", detail:"Laine fine navy, coupe droite, revers discret — ton sur ton avec la veste, tombé parfait" },
    { x:44, y:88, label:"Chaussures — Derbies navy", detail:"Cuir navy cousu Goodyear, chaussettes fil d'Écosse rayées navy & blanc — artisanat français" },
  ],
  [ // 3 — Veste Orange
    ...
    { x:50, y:62, label:"Bas — Pantalon noir slim", detail:"Laine noire, coupe slim, légèrement taille haute — tombé parfait, couture sur-mesure" },
    { x:44, y:88, label:"Chaussures — Derbies cuir camel", detail:"Cuir lisse camel, bout carré, chaussettes fil d'Écosse noires — fabrication artisanale" },
  ],
  [ // 4 — Costume Carreaux
    ...
    { x:51, y:41, label:"Cravate — Soie assortie carreaux", detail:"Soie tissée carreaux 7 cm, nœud four-in-hand, barrette dorée — longueur sur-mesure" },
    { x:50, y:62, label:"Bas — Pantalon carreaux assorti", detail:"Laine anglaise carreaux sur-mesure, coupe droite, revers 1,5 cm — tombé classique" },
    { x:44, y:88, label:"Chaussures — Oxford bicolores", detail:"Cuir patiné camel & marron, semelle Goodyear, chaussettes argyle laine fin ton sur ton" },
  ],
  [ // 5 — Veste Bleue
    ...
    { x:50, y:62, label:"Bas — Pantalon crème", detail:"Lin crème, coupe droite sur-mesure, ceinture discrète assortie — contraste élégant" },
    { x:44, y:88, label:"Chaussures — Richelieu marine", detail:"Cuir bleu marine cousu Goodyear, finition miroir, chaussettes soie marine" },
  ],
  [ // 6 — Style Parisien
    ...
    { x:50, y:62, label:"Bas — Pantalon chino taupe", detail:"Coton taupe, coupe slim légèrement conique sur-mesure, ourlet brut — allure urbaine" },
    { x:44, y:88, label:"Chaussures — Chelsea cuir brun", detail:"Cuir brun waxé, élastiques crème, semelle Vibram, chaussettes laine mérinos marron" },
  ],
  [ // 7 — Chemise Lavande
    ...
    { x:50, y:62, label:"Bas — Pantalon crème lin", detail:"Lin crème cassé, coupe droite, revers léger, ceinture fine — tissu respirant, été & soirée" },
    { x:44, y:88, label:"Chaussures — Loafers mocca dorés", detail:"Cuir mocca, boucle dorée ciselée artisanat italien, chaussettes fil d'Écosse beige & lavande" },
  ],
  [ // 8 — Costume Bleu & Rouge
    ...
    { x:51, y:39, label:"Nœud papillon — Soie bordeaux", detail:"Soie bordeaux à nouer sur-mesure — accord chromatique parfait avec le rouge du costume" },
    { x:50, y:62, label:"Bas — Pantalon bicolore assorti", detail:"Laine sur-mesure, coupe slim — partie basse du costume bicolore, pièce unique" },
    { x:44, y:88, label:"Chaussures — Derbies noirs miroir", detail:"Cuir noir lisse, finition miroir absolue, chaussettes soie noire ultra-fine — élégance soirée" },
  ],
  [ // 9 — Veste Bleue Rayée
    ...
    { x:51, y:41, label:"Cravate — Soie navy", detail:"Soie navy 7 cm, micro-motifs tissés, nœud Pratt, barrette plaqué or — finesse absolue" },
    { x:50, y:62, label:"Bas — Pantalon blanc slim", detail:"Laine légère blanche, coupe slim, ourlet net — lumineux et tranchant face à la veste" },
    { x:44, y:88, label:"Chaussures — Derby bicolores blanc & marine", detail:"Cuir blanc & bleu marine, bout captoe, chaussettes fil d'Écosse blanc & navy — faits main" },
  ],
  [ // 10 — Costume Bordeaux
    ...
    { x:51, y:41, label:"Cravate — Soie bordeaux motifs", detail:"Soie bordeaux, motifs cachemire tissés discrets 7,5 cm, nœud Windsor — longueur sur-mesure" },
    { x:50, y:62, label:"Bas — Pantalon bordeaux assorti", detail:"Laine fine bordeaux sur-mesure, coupe droite, pli marqué — partie basse du 3 pièces" },
    { x:44, y:88, label:"Chaussures — Oxford bordeaux patiné", detail:"Cuir bordeaux Goodyear, chaussettes cachemire bordeaux — accord total tête aux pieds" },
  ],
  [ // 11 — Promenade Blanche
    ...
    { x:50, y:62, label:"Bas — Pantalon fluide blanc", detail:"Tombé fluide blanc cassé, coupe droite légèrement évasée sur-mesure — tissu prestige" },
    { x:44, y:88, label:"Chaussures — Sneakers cuir blanc", detail:"Cuir blanc premium, semelle crème, socquettes coton blanc — édition limitée" },
  ],
  [ // 12 — Smoking Doré
    ...
    { x:51, y:39, label:"Nœud papillon — Soie dorée", detail:"Soie bronze dorée à nouer sur-mesure — reflet miroir des revers satin du smoking" },
    { x:50, y:62, label:"Bas — Pantalon smoking noir", detail:"Laine fine noire, galon satin sur couture — coupe slim, sans ceinture, bretelles soie dorée" },
    { x:44, y:88, label:"Chaussures — Souliers vernis noirs", detail:"Vernis noir, bout en amande, finition miroir absolue, chaussettes soie noire Fil de Calais" },
  ],
  [ // 13 — Veste Navy Soirée
    ...
    { x:51, y:39, label:"Nœud papillon — Soie navy satin", detail:"Soie navy satin mat à nouer sur-mesure — continuité parfaite avec les revers de la veste" },
    { x:50, y:62, label:"Bas — Pantalon smoking navy", detail:"Laine navy, galon satin nuit sur couture — coupe slim effilée, sans revers" },
    { x:44, y:88, label:"Chaussures — Oxford vernis noir", detail:"Oxford vernis, finition miroir absolue, chaussettes soie noire Fil de Calais — luxe invisible" },
  ],
  [ // 14 — Costume Carreaux Rose
    ...
    { x:50, y:62, label:"Bas — Pantalon rose carreaux assorti", detail:"Laine italienne rose poudré, coupe droite sur-mesure — partie basse du costume coordonné" },
    { x:44, y:88, label:"Chaussures — Derby rose poudré", detail:"Cuir rose poudré sur-mesure, bout captoe, chaussettes fil d'Écosse rose clair — pièce unique" },
  ],
];
