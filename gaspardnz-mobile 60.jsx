...
const _STL_SPOTS = [
  [ // 0 — Costume Crème
    { x:38, y:32, label:"Costume 3 pièces crème", detail:"Lin crème sur-mesure, coupe ajustée, revers en pointe — veste, gilet & pantalon assortis" },
    { x:65, y:36, label:"Pochette de costume", detail:"Pochette soie crème, pliage signature Gaspardnz, bordure dorée" },
    { x:53, y:42, label:"Chemise sur-mesure", detail:"Popeline blanche, col cutaway, boutons de nacre — repassage facile garanti" },
    { x:53, y:52, label:"Ceinture cuir crème", detail:"Cuir pleine fleur crème, boucle dorée satiné, coutures fines apparentes" },
    { x:40, y:80, label:"Derby bicolores", detail:"Cuir caramel & crème, semelle cuir Goodyear — finition artisanale, chaussettes fil d'Écosse crème incluses" },
  ],
  [ // 1 — Élégance Blanche
    { x:38, y:30, label:"Veste structurée blanche", detail:"Épaules structurées, blanc cassé sur-mesure, boutons nacre, doublure soie ivoire" },
    { x:62, y:35, label:"Pochette blanche", detail:"Pochette lin blanc, pliage trois pointes — détail de finesse" },
    { x:50, y:42, label:"Chemise blanche sur-mesure", detail:"Col français, blanc pur, coupe slim, poignets double-bouton sur-mesure" },
    { x:50, y:56, label:"Pantalon à revers", detail:"Blanc cassé, coupe droite, revers 2 cm, pli creux — fait main, tissu laine légère" },
    { x:50, y:82, label:"Derby blancs", detail:"Cuir blanc patiné, bout captoe, chaussettes soie blanches — semelle cuir naturel" },
  ],
  [ // 2 — Veste Rayée
    { x:38, y:30, label:"Veste rayée sur-mesure", detail:"Rayures contrastées navy & crème, coupe slim, doublure soie navy, 2 boutons" },
    { x:62, y:34, label:"Pochette rayée", detail:"Pochette soie assortie, rayures fines — pliage plat signature" },
    { x:50, y:40, label:"Chemise brodée", detail:"Popeline blanche, broderies fines sur col & poignets, coupe ajustée sur-mesure" },
    { x:53, y:50, label:"Cravate slim", detail:"Soie navy slim 6 cm, motifs discrets tissés, nœud four-in-hand — longueur ajustée" },
    { x:48, y:70, label:"Pantalon uni navy", detail:"Laine fine navy, coupe droite, revers discret — ton sur ton coordonné" },
    { x:48, y:85, label:"Chaussures & chaussettes", detail:"Derbies cuir navy, chaussettes fil d'Écosse rayées navy & blanc — finition Goodyear" },
  ],
  [ // 3 — Veste Orange
    { x:38, y:30, label:"Veste orange vif", detail:"Orange vif, cintrée sur-mesure, doublure soie bronze, boutons corne — pièce signature" },
    { x:62, y:36, label:"Pochette soie blanche", detail:"Pochette blanche pur, pliage présidentiel — contraste élégant" },
    { x:50, y:42, label:"Chemise col officier", detail:"Popeline blanche, col officier boutonné, coupe slim sur-mesure, sans cravate" },
    { x:53, y:52, label:"Pantalon noir slim", detail:"Laine noire, coupe slim ajustée, taille haute légèrement — tombé parfait" },
    { x:54, y:80, label:"Chaussures cuir camel", detail:"Derbies cuir lisse camel, bout carré — chaussettes noires fil d'Écosse — fabrication artisanale" },
  ],
  [ // 4 — Costume Carreaux
    { x:38, y:30, label:"Costume prince-de-galles", detail:"2 pièces, carreaux fins navy & crème, laine anglaise sur-mesure, revers en pointe" },
    { x:58, y:36, label:"Cravate slim soie", detail:"Soie tissée assortie, 7 cm, nœud four-in-hand signé Gaspardnz, barrette dorée" },
    { x:65, y:37, label:"Pochette carreaux", detail:"Pochette soie coordonnée, carreaux fins — pliage deux pointes" },
    { x:50, y:44, label:"Chemise à rayures fines", detail:"Rayures fines bleues sur blanc, col cutaway, coupe slim sur-mesure, manchettes simples" },
    { x:53, y:53, label:"Boutons de manchettes", detail:"Boutons manchettes plaqués or, gravure initiales possible — finition poli brillant" },
    { x:50, y:82, label:"Oxford bicolores & chaussettes", detail:"Cuir patiné camel & marron, semelle Goodyear — chaussettes argyle laine fin, ton sur ton" },
  ],
  [ // 5 — Veste Bleue
    { x:38, y:30, label:"Veste bleue nuit structurée", detail:"Bleu nuit sur-mesure, épaules structurées, boutons dorés ciselés, doublure soie" },
    { x:62, y:35, label:"Pochette blanche", detail:"Pochette lin blanc pur, pliage plat — sobriété de haut vol" },
    { x:50, y:42, label:"Chemise col français", detail:"Blanc pur, col français ouvert, coupe slim, double manchette — boutons de nacre" },
    { x:53, y:52, label:"Pantalon crème", detail:"Lin crème coupe droite, taille ajustée sur-mesure, ceinture discrète" },
    { x:53, y:82, label:"Richelieu marine & chaussettes", detail:"Richelieu cuir bleu marine cousu Goodyear, finition miroir — chaussettes soie marine" },
  ],
  [ // 6 — Style Parisien
    { x:38, y:30, label:"Manteau coupe parisienne", detail:"Laine cachemire mélangée, coupe droite parisienne sur-mesure, boutonnage croisé" },
    { x:50, y:44, label:"Chemise col boutonné", detail:"Tissu Oxford bleu ciel, col boutonné, coupe slim sur-mesure — décontracté chic" },
    { x:50, y:55, label:"Pantalon chino taupe", detail:"Coton taupe, coupe slim légèrement conique, ourlet brut — allure urbaine" },
    { x:52, y:83, label:"Bottines Chelsea & chaussettes", detail:"Chelsea cuir brun waxé, élastiques crème, semelle Vibram — chaussettes laine mérinos marron" },
  ],
  [ // 7 — Chemise Lavande
    { x:38, y:30, label:"Chemise lavande brodée", detail:"Popeline lavande doux, broderies main sur col, poignets & plastron — col classique sur-mesure" },
    { x:62, y:34, label:"Boutons de manchettes", detail:"Boutons manchettes argent brossé, forme ronde — finition matte élégante" },
    { x:50, y:48, label:"Pantalon crème", detail:"Lin crème cassé, coupe droite, revers léger, ceinture fine — tissu respirant" },
    { x:53, y:55, label:"Ceinture cuir naturel", detail:"Cuir naturel tannage végétal, boucle argentée, couture sellier — patine unique avec le temps" },
    { x:50, y:83, label:"Loafers & chaussettes", detail:"Loafers cuir mocca, boucle dorée ciselée artisanat italien — chaussettes fil d'Écosse beige & lavande" },
  ],
  [ // 8 — Costume Bleu & Rouge
    { x:38, y:30, label:"Costume bicolore unique", detail:"2 tons bleu saphir & rouge profond sur-mesure — pièce unique, coupe moderne cintrée, doublure contrastée" },
    { x:57, y:36, label:"Nœud papillon bordeaux", detail:"Soie bordeaux, nœud papillon à nouer sur-mesure — accord parfait avec le rouge du costume" },
    { x:50, y:43, label:"Chemise blanche sur-mesure", detail:"Popeline blanche, col classique, plastron piqué, double manchette — boutons de nacre dorée" },
    { x:53, y:52, label:"Boutons de manchettes dorés", detail:"Boutons manchettes plaqués or 18k, forme carrée — gravure possible sur commande" },
    { x:50, y:83, label:"Souliers de soirée & chaussettes", detail:"Derbies cuir noir lisse, finition miroir — chaussettes soie noire ultra-fine, invisible sous le pantalon" },
  ],
  [ // 9 — Veste Bleue Rayée
    { x:38, y:30, label:"Veste bleue rayée fine", detail:"Rayures fines bleu & blanc, coupe ajustée sur-mesure, revers cranté, doublure soie" },
    { x:62, y:35, label:"Pochette blanche", detail:"Pochette lin blanc, pliage droit — élégance minimaliste" },
    { x:50, y:42, label:"Chemise unie coupe slim", detail:"Blanc pur, coupe slim ajustée, col semi-cutaway sur-mesure — manchette simple" },
    { x:53, y:53, label:"Cravate navy", detail:"Cravate soie navy 7 cm, tissage micro-motifs — nœud Pratt, barrette plaqué or" },
    { x:50, y:70, label:"Pantalon blanc slim", detail:"Laine légère blanche, coupe slim, ourlet propre — contrepoint parfait à la veste" },
    { x:50, y:84, label:"Derby bicolores & chaussettes", detail:"Cuir blanc & bleu marine, bout captoe — chaussettes fil d'Écosse blanc & navy, fabriqués main" },
  ],
  [ // 10 — Costume Bordeaux
    { x:38, y:30, label:"Costume bordeaux 3 pièces", detail:"Laine fine bordeaux, 3 pièces sur-mesure — veste, gilet & pantalon, revers en pointe" },
    { x:65, y:34, label:"Pochette soie dorée", detail:"Pochette soie dorée, pliage en crête signature Gaspardnz — touche d'éclat" },
    { x:57, y:40, label:"Cravate bordeaux à motifs", detail:"Soie bordeaux, motifs cachemire tissés discrets, 7,5 cm — nœud Windsor, longueur ajustée" },
    { x:50, y:45, label:"Chemise col français", detail:"Blanc pur, col français ouvert, double manchette — boutons de nacre, tissu end-on-end" },
    { x:53, y:53, label:"Boutons de manchettes en or", detail:"Boutons manchettes or jaune, forme ovale — possibilité de gravure initiales" },
    { x:50, y:83, label:"Oxford bordeaux & chaussettes", detail:"Oxford cuir bordeaux patiné, Goodyear — chaussettes cachemire bordeaux, chaud & doux" },
  ],
  [ // 11 — Promenade Blanche
    { x:38, y:30, label:"Veste blanche slim", detail:"Blanc cassé, boutons nacrés irisés, coupe slim sur-mesure, doublure lin écru" },
    { x:50, y:40, label:"Polo col montant blanc", detail:"Maille fine pima cotton, col montant boutonné, blanc pur — allure décontractée premium" },
    { x:50, y:56, label:"Pantalon fluide blanc", detail:"Tissu blanc cassé à tombé fluide, coupe droite légèrement évasée sur-mesure — tissu prestige" },
    { x:53, y:65, label:"Ceinture blanche", detail:"Cuir blanc pleine fleur, boucle argentée mate — finition naturelle" },
    { x:50, y:83, label:"Sneakers cuir & chaussettes", detail:"Sneakers cuir blanc premium, semelle crème — chaussettes socquettes coton blanc, discrets sous le pantalon" },
  ],
  [ // 12 — Smoking Doré
    { x:38, y:30, label:"Smoking doré sur-mesure", detail:"Reflets bronze dorés, revers satin or, coupe soirée de gala — doublure soie champagne, 1 bouton" },
    { x:57, y:36, label:"Nœud papillon doré", detail:"Soie tissée bronze doré, à nouer sur-mesure — accord parfait avec les revers du smoking" },
    { x:50, y:42, label:"Chemise plastron blanc", detail:"Col cassé, plastron piqué 3 rangs, boutons de nacre dorée sur-mesure — tissu coton égyptien" },
    { x:53, y:53, label:"Boutons de manchettes en or", detail:"Boutons manchettes or 18k, cabochon nacre — finition orfèvrerie, pièce de collection" },
    { x:50, y:65, label:"Pantalon smoking", detail:"Laine fine noire, galon satin sur couture — coupe slim, sans ceinture, bretelles soie dorée" },
    { x:50, y:84, label:"Souliers & chaussettes de soirée", detail:"Vernis noir bout en amande, finition miroir absolue — chaussettes soie noire ultra-fine" },
  ],
  [ // 13 — Veste Navy Soirée
    { x:38, y:30, label:"Veste tuxedo navy", detail:"Tuxedo navy sur-mesure, revers satin bleu nuit, 1 bouton — doublure soie navy, coupe soirée" },
    { x:57, y:36, label:"Nœud papillon navy", detail:"Soie navy à nouer sur-mesure, texture satin mat — coordonné revers & souliers" },
    { x:50, y:42, label:"Chemise col cassé", detail:"Blanc, col cassé, plastron simple, manchette double sur-mesure — tissu coton end-on-end" },
    { x:53, y:52, label:"Boutons de manchettes argent", detail:"Boutons manchettes argent rhodié, forme T-bar — finition miroir, sans ostentation" },
    { x:50, y:65, label:"Pantalon smoking navy", detail:"Laine navy, galon satin nuit sur couture — coupe slim effilée, sans revers" },
    { x:50, y:84, label:"Oxford vernis & chaussettes", detail:"Oxford vernis noir, finition miroir absolue — chaussettes soie noire Fil de Calais, pointe de luxe" },
  ],
  [ // 14 — Costume Carreaux Rose
    { x:38, y:30, label:"Costume carreaux rose", detail:"Rose poudré, carreaux fins sur-mesure, coupe moderne cintrée, 2 boutons — laine italienne douce" },
    { x:62, y:35, label:"Pochette blanche", detail:"Pochette lin blanc, pliage un pic — sobriété chic sur fond rose" },
    { x:50, y:42, label:"Chemise blanche sur-mesure", detail:"Popeline blanche, col classique, coupe slim — manchette simple boutonnée, tissu premium" },
    { x:57, y:50, label:"Ceinture cuir boucle dorée", detail:"Cuir lisse rosé, boucle dorée ciselée — accessoire signature assorti au costume" },
    { x:53, y:53, label:"Boutons de manchettes rose or", detail:"Boutons manchettes plaqués or rosé, forme ronde bombée — accord parfait avec le costume" },
    { x:50, y:83, label:"Derby rose & chaussettes", detail:"Cuir rose poudré sur-mesure, bout captoe — chaussettes fil d'Écosse rose clair, pièce assortie unique" },
  ],
];
