    ...
    {visible && (
      ...
      >
        ...
        >
          ...
          <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "7px", letterSpacing: "0.45em", color: GOLD, textTransform: "uppercase", marginBottom: "0.9rem" }}>
            GASPARDNZ · EXCLUSIVITÉS
          </p>

          <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.5rem, 6vw, 1.8rem)", fontWeight: 300, color: "#faf7f2", lineHeight: 1.15, margin: "0 0 0.9rem" }}>
            Bons plans<br />en avant-première
          </h3>

          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: "1rem", color: "rgba(245,240,232,0.5)", lineHeight: 1.7, marginBottom: "1.8rem" }}>
            Pièces uniques, promotions exclusives et arrivages : reçois les alertes avant tout le monde.
          </p>
