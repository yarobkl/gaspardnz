  ...
  return (
    <SeoLayout>
      ...
      <section style={{ maxWidth: 1120, margin: "0 auto", padding: "clamp(4rem,9vw,8rem) 1.25rem 4rem" }}>
        <p style={{ margin: "0 0 1rem", color: GOLD, fontFamily: "'Montserrat', sans-serif", fontSize: 11, letterSpacing: ".28em", textTransform: "uppercase" }}>Paris · Mariages · Galas · Événements</p>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: "2rem" }}>
          <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" data-track="booking_start" style={{ ...buttonStyle, background: GOLD, color: "#1c1208", border: `1px solid ${GOLD}` }}>Réserver un échange</a>
          <a href={waHref} target="_blank" rel="noopener noreferrer" data-track="whatsapp_click" style={{ ...buttonStyle, color: CREAM, border: "1px solid rgba(245,240,232,.32)" }}>Écrire sur WhatsApp</a>
        </div>
      </section>
