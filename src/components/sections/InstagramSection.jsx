  ...
  return (
    <section ref={ref} style={{ background: "#faf7f2", padding: "4rem 0 4.5rem" }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 1.4rem", marginBottom: "1.2rem" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "2px" }}>
        {posts.map((p, i) => (
