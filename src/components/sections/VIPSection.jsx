...
const VIPClientsSection = () => {
  ...
  const clients = [
    { initials: "R.B", name: "Rodrin Bakala Mouengue", city: "Paris", event: "Mariage", gradient: "linear-gradient(135deg,#1e3a5f,#2d6a9f)", photo: `${B}images/rodrin-bakala.jpg.JPG`,
      album: [`${B}images/rodrin-bakala.jpg.JPG`, `${B}images/rodrin-mariage-1.jpg`, `${B}images/rodrin-mariage-2.jpg`, `${B}images/rodrin-mariage-3.jpg`, `${B}images/rodrin-mariage-4.jpg`, `${B}images/mariage-smoking-dore.jpg`] },
