  ...
  return (
    <section ref={ref} style={{ background: "#0a0602", padding: "4.5rem 1.4rem 5rem" }}>
      <motion.div
        ...
        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: "1rem", color: "rgba(245,240,232,0.5)", lineHeight: 1.65, marginBottom: "1.8rem" }}>Conseils style exclusifs, avant-premières, looks de la semaine et coulisses des shootings — uniquement sur WhatsApp.</p>
        ...
        <motion.a href={WA_CHANNEL_URL} target="_blank" rel="noopener noreferrer" whileTap={{ scale: 0.97 }}
