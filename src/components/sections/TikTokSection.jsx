  ...
  return (
    <section ref={ref} style={{ background: "#0a0602", padding: "4.5rem 0 5rem" }}>
      <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "7px", letterSpacing: "0.45em", color: "rgba(250,247,242,0.25)", textTransform: "uppercase", textAlign: "center", marginBottom: "16px" }}>{t("tiktok_comments_pinned")}</p>
        <div style={{ background: "#161210", borderRadius: "14px", padding: "1.1rem 1.2rem", border: "1px solid rgba(184,151,62,0.18)", maxWidth: "340px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "9px", color: "rgba(250,247,242,0.35)", margin: "2px 0 0" }}>{t("tiktok_verified_artist")}</p>
            </div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.55 }}
        ...
        <motion.a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noopener noreferrer"
          ...
          <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "9px", letterSpacing: "0.3em", color: GOLD, textTransform: "uppercase" }}>{t("tiktok_follow")}</span>
        </motion.a>
      </motion.div>
    </section>
  );
