        ...
        <div style={{ background: "#161210", borderRadius: "14px", padding: "1.1rem 1.2rem", border: "1px solid rgba(184,151,62,0.18)", maxWidth: "340px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "9px", color: "rgba(250,247,242,0.78)", margin: "2px 0 0" }}>{t("tiktok_verified_artist")}</p>
            </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
            ...
            <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "10px", color: "rgba(250,247,242,0.76)" }}>607</span>
          </div>
        </div>
      </motion.div>
