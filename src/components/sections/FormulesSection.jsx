...
const FormulaCard = ({ formula, defaultOpen = false }) => {
  ...
  const waMsg = encodeURIComponent(
    `Bonjour Gaspard, je suis intéressé(e) par la ${formula.title}. Pouvez-vous m'en dire plus ?`
  );
...
const FormulesSection = ({ refEl }) => {
  ...
  const formules = [
    {
      id: "prestige",
      surtitle: t("formules_surtitle"),
      title: t("formule_prestige_titre"),
      price: "695€",
      priceNote: true,
      ...
      looks: [
        {
          label: t("look_mairie"),
          items: [
            { label: t("item_costume"), included: true },
            { label: t("item_chemise"), included: true },
            { label: t("item_cravate"), included: true },
            { label: t("item_boutons"), included: true },
            { label: t("item_chaussettes"), included: true },
            { label: t("item_chaussures_opt"), price: t("item_chaussures_prix") },
          ],
        },
        {
          label: t("look_soiree"),
          items: [
            { label: t("item_smoking"), included: true },
            { label: t("item_noeud"), included: true },
            { label: t("item_plastron"), included: true },
            { label: t("item_boutons"), included: true },
            { label: t("item_chaussettes"), included: true },
            { label: t("item_chaussures_opt"), price: t("item_chaussures_prix") },
          ],
    ...
    },
    {
      id: "gnz",
      surtitle: t("formules_surtitle"),
      title: t("formule_gnz_titre"),
      price: t("prix_sur_demande"),
      priceNote: false,
  ...
  return (
    <section ref={node => { ref.current = node; if (refEl) refEl.current = node; }} style={{ background: "#0a0602", padding: "4.5rem 0 5rem" }}>
      <motion.div
        ...
        style={{ padding: "0 1.4rem", marginBottom: "2.4rem", textAlign: "center" }}>
