  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0a0602", color: CREAM }}>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "clamp(4rem,9vw,8rem) 1.25rem 4rem" }}>
        <p style={{ color: GOLD, fontFamily: "'Montserrat', sans-serif", fontSize: 11, letterSpacing: ".28em", textTransform: "uppercase", margin: "0 0 1rem" }}>Conseil en image · Homme · Paris</p>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: "2rem" }}>
          ...
          <a href={waHref} target="_blank" rel="noopener noreferrer" data-track="whatsapp_click" style={{ ...buttonStyle, color: CREAM, border: "1px solid rgba(245,240,232,.3)" }}>Échanger sur WhatsApp</a>
        </div>
      </section>
