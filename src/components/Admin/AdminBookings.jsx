...
import { listBookings, updateBooking } from "../../services/adminData.js";
...
export default function AdminBookings() {
  ...
  const load = async () => {
    setLoading(true);
    try { setRows(await listBookings(250)); setError(""); }
  ...
  return <div>
    <div className="gnz-page-heading"><div><h1>Réservations</h1><p>Demandes de rendez-vous et rendez-vous confirmés, synchronisables avec Calendly.</p></div><div className="gnz-page-actions"><button className="gnz-secondary-button" onClick={load}>Actualiser</button></div></div>
