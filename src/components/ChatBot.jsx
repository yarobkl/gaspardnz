          ...
          <motion.div
            ...
            <div style={{ padding: "0.8rem", borderTop: "1px solid rgba(184,151,62,0.1)", display: "flex", gap: "0.5rem", flexShrink: 0, background: "#faf7f2" }}>
              <input
                ...
                style={{ flex: 1, background: "#fff", border: "1px solid rgba(184,151,62,0.2)", padding: "0.6rem 0.9rem", fontFamily: "'Montserrat', sans-serif", fontSize: "12px", color: TEXT, outline: `2px solid ${GOLD}`, outlineOffset: "2px", borderRadius: "20px" }}
              />
