export const T = {
  FR: {
    ...
    notif_label:"NOTIFICATIONS · GASPARDNZ",
    notif_title_l1:"Restez dans",
    notif_title_l2:"l'exclusivité",
    notif_desc:"Bons plans, arrivages et looks exclusifs directement sur votre téléphone.",
    notif_accept:"Activer les notifications",
    notif_decline:"Plus tard",
    comm_surtitle:"CANAL WHATSAPP · GASPARDNZ",
    comm_title_l1:"Rejoins la",
    comm_title_l2:"Communauté",
    comm_desc:"Nouveaux looks, arrivages exclusifs, coulisses : reçois tout en avant-première directement sur WhatsApp.",
    comm_badge_title:"AVANTAGES EXCLUSIFS",
    comm_badge_sub:"réservés aux membres de la communauté",
    comm_cta:"REJOINDRE LE CANAL",
    cookie_text:"Nous utilisons des cookies pour analyser notre trafic et améliorer votre expérience.",
  ...
  EN: {
    ...
    notif_label:"NOTIFICATIONS · GASPARDNZ",
    notif_title_l1:"Stay in the",
    notif_title_l2:"exclusivity",
    notif_desc:"Deals, new arrivals and exclusive looks directly on your phone.",
    notif_accept:"Enable notifications",
    notif_decline:"Later",
    comm_surtitle:"WHATSAPP CHANNEL · GASPARDNZ",
    comm_title_l1:"Join the",
    comm_title_l2:"Community",
    comm_desc:"New looks, exclusive arrivals, behind the scenes: get everything first directly on WhatsApp.",
    comm_badge_title:"EXCLUSIVE BENEFITS",
    comm_badge_sub:"reserved for community members",
    comm_cta:"JOIN THE CHANNEL",
    cookie_text:"We use cookies to analyze our traffic and improve your experience.",
  ...
  ES: {
    ...
    notif_label:"NOTIFICACIONES · GASPARDNZ",
    notif_title_l1:"Mantente en la",
    notif_title_l2:"exclusividad",
    notif_desc:"Ofertas, nuevas llegadas y looks exclusivos directamente en tu teléfono.",
    notif_accept:"Activar notificaciones",
    notif_decline:"Más tarde",
    comm_surtitle:"CANAL WHATSAPP · GASPARDNZ",
    comm_title_l1:"Únete a la",
    comm_title_l2:"Comunidad",
    comm_desc:"Nuevos looks, llegadas exclusivas, backstage: recibe todo primero directamente en WhatsApp.",
    comm_badge_title:"BENEFICIOS EXCLUSIVOS",
    comm_badge_sub:"reservados para miembros de la comunidad",
    comm_cta:"UNIRSE AL CANAL",
    cookie_text:"Usamos cookies para analizar nuestro tráfico y mejorar tu experiencia.",
  ...
  ZH: {
    ...
    notif_label:"通知 · GASPARDNZ",
    notif_title_l1:"保持",
    notif_title_l2:"独家优先",
    notif_desc:"优惠、新品和独家造型直接发送到您的手机。",
    notif_accept:"开启通知",
    notif_decline:"稍后",
    comm_surtitle:"WHATSAPP 频道 · GASPARDNZ",
    comm_title_l1:"加入",
    comm_title_l2:"社区",
    comm_desc:"新造型、独家新品、幕后故事：通过 WhatsApp 第一时间获取所有信息。",
    comm_badge_title:"专属权益",
    comm_badge_sub:"仅限社区成员",
    comm_cta:"加入频道",
    cookie_text:"我们使用 Cookie 分析流量并改善您的体验。",
    cookie_accept:"接受",
    cookie_decline:"拒绝",
  },
};
