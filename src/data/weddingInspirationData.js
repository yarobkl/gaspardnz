export const WEDDING_INSPIRATIONS = {
  FR: [
    {
      id: 1,
      title: "Inspiration look Mariage",
      desc: "Un album terracotta élégant : gilet ivoire, chemise blanche, cravate vert pastel et richelieu marron. Deux angles pour visualiser le look complet avant de préparer votre tenue.",
  ...
  EN: [
    {
      id: 1,
      title: "Wedding Look Inspiration",
      desc: "An elegant terracotta album: ivory waistcoat, white shirt, pastel green tie and brown oxfords. Two angles to picture the full look before preparing your outfit.",
  ...
  ES: [
    {
      id: 1,
      title: "Inspiración look Boda",
      desc: "Un álbum terracota elegante: chaleco marfil, camisa blanca, corbata verde pastel y oxford marrones. Dos ángulos para visualizar el look completo.",
  ...
  ZH: [
    {
      id: 1,
      title: "婚礼造型灵感",
      desc: "优雅红土色相册：象牙色马甲、白衬衫、浅绿色领带与棕色牛津鞋。两个角度完整呈现婚礼造型。",
      color: "红土色 & 白色",
      style: "优雅 & 精致",
      occasion: "婚礼, 晚会",
      src: `${import.meta.env.BASE_URL}images/terracotta-look-1.jpg`,
