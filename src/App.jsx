  ...
  <motion.div
    ...
    <div style={{ position: "absolute", bottom: "0.8rem", left: 0, right: 0, zIndex: 1 }}>
      <motion.p
        ...
        style={{ fontFamily: "'Dancing Script', cursive", fontWeight: 700, fontSize: "1.5rem", color: "rgba(245,240,232,0.92)", textAlign: "center", margin: "0 0 0.8rem", textShadow: "0 2px 20px rgba(0,0,0,0.8)" }}>
