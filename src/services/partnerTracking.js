...
export const sendPartnerContactEmail = async (partnerId, partnerEmail, clientData, partnerStatus = null, partnerName = "") => {
  try {
    ...
    const emailData = {
      ...
      // Anti-bot metadata generated by the contact form. These fields are never
      // persisted to CRM or email logs.
      website: String(clientData.website || "").slice(0, 200),
      formStartedAt: Number(clientData.formStartedAt) || null,
    };
