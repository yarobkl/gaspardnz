  ...
  PushNotifications.addListener("registration", async ({ value: token }) => {
    ...
    try {
      await fetch("https://onesignal.com/api/v1/players", {
        ...
        body: JSON.stringify({ app_id: ONESIGNAL_APP_ID, device_type: 0, identifier: token, language: "fr", timezone: 3600, tags: { source: "gaspardnz_app" } }),
      });
    } catch (_) {}
  });
...
export async function requestNotificationPermission() {
  ...
  if (receive === "granted") { await registerPushToken(); return true; }
